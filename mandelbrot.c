// mandelbrot.c - Interactive Mandelbrot Set in OpenGL 4.0
...
// Fragment shader source code for Mandelbrot set
...
"    float scaledT = t * 4.0; // Scale t to fit in the range of the palette\n"
"    int idx1 = int(scaledT); // Base color index\n"
"    int idx2 = idx1 + 1; // Next color index\n"
"    float fraction = fract(scaledT); // Fractional part for interpolation\n"
"    return mix(palette[idx1], palette[min(idx2, 4)], fraction); // Smooth blend between colors\n"
"}\n"
"\n"
"void main()\n"
"{\n"
"    dvec2 c = (gl_FragCoord.xy - 0.5 * resolution) / (resolution.y * zoom) + offset;\n"
"    dvec2 z = c;\n"
"    int i;\n"
...
// Callback for key input (invert colors, color modes, adjust iterations, and quit)
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Interactive Mandelbrot Set", NULL, NULL);
    if (!window)
    {
